    ...
    public class ChatController : ControllerBase
    {
        ...
        public async Task<IActionResult> Chat([FromBody] JsonElement payload)
        {
            ...
            var contentJson = JsonSerializer.Serialize(new
            {
                ...
                {
                    new {
                        parts = new[] { new { text = $"你是一個智慧客服助理，負責回答有關訂單管理系統的問題，請用中文正確回覆問題，僅回答與問題直接相關的部分，功能包括：登入、登出、註冊、忘記密碼、查詢、新增、修改、刪除訂單，帳號密碼保護，資料加密，安全有保障。登入:輸入帳號與密碼即可登入系統。登出:點選登出，註冊:填寫帳號、密碼與Email建立帳戶。忘記密碼:請輸入註冊信箱，收到信後點選重設密碼並輸入新密碼進行變更。查詢訂單:登入系統後可查詢訂單狀態。新增訂單:登入後點選新增訂單，填寫商品與數量後送出。修改訂單:於訂單列表點選編輯進行修改。刪除訂單:點選刪除後確認即可移除該筆訂單。{userMessage}" } }
                    }
                }
            });

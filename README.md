...
一套基於 **Vue.js 前端** 和 **ASP.NET 後端** 的智慧訂單管理系統，支援透過 Docker 和 GitHub Actions 自動部署至 [Render](https://render.com)。  
...
project (Frontend Vue)
   ...
   |  REST API
   ▼
manufacturing_system (Backend ASP.NET) ——> PostgreSQL (hosted on Neon)
